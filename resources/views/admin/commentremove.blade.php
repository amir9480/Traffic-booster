...
<div class="alert alert-warning">
    <span>آیا برای حزف کامنت   
   {{ $comment->content }}
   مطمئنید؟ 
    </span>
</div>
<div class="myform_layout">
<form class="myappform form-horizontal center-block" dir="rtl" action="{{$app['url']->to('/admin/comments/remove/').'/'.$comment->id}}" method="post">
