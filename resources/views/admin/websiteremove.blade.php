...
<div class="alert alert-warning">
    <span>آیا برای حزف سایت   
   {{ $website->title }}
   مطمئنید؟ 
    </span>
</div>
<div class="myform_layout">
<form class="myappform form-horizontal center-block" dir="rtl" action="{{$app['url']->to('/admin/websites/remove/').'/'.$website->id}}" method="post">
