...
@if( isset($successfull) )
    <h2> وبسایت های کاربر مورد نظر حزف شد</h2>
@else
...
<div class="alert alert-warning">
    <span>آیا برای حزف تمام سایت های کاربر   
   {{ $website->user->username }}
   مطمئنید؟ 
    </span>
</div>
<div class="myform_layout">
<form class="myappform form-horizontal center-block" dir="rtl" action="{{$app['url']->to('/admin/websites/removeall/').'/'.$website->id}}" method="post">
